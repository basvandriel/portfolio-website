...
export const caseStudies: CaseStudy[] = [
  {
    ...
    title:
      "Accelerating Chemical R&D: From 50+ Siloed Systems to Unified AI-Ready Platform",
    client: "BASF",
    ...
    problem: {
      title:
        "Research teams losing weeks waiting for data from disconnected systems",
      description:
    ...
    solution: {
      title:
        "Self-service data platform enabling scientists to access unified data in hours",
      approach:
