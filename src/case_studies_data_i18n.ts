...
export const caseStudiesNL: CaseStudyI18n[] = [
  ...
  },
  {
    ...
    problem: {
      ...
      description:
        "Het data-team van ABN AMRO zat vast in een eindeloze cyclus. 50+ financiële systemen die data aanleveren. Elke bron had handmatige integratie, validatie en kwaliteitscontroles nodig. Het team was elke week 40+ uur kwijt aan het simpelweg checken van datakwaliteit. Ondertussen groeide de backlog maar door. Business teams die maanden moesten wachten op nieuwe databronnen. Compliance-rapportages die deadlines dreigden te missen.",
      pain_points: [
